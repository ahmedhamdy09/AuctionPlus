// import AgoraRTC, { AgoraRTCErrorCode } from "agora-rtc-react";
import React from "react";
import logoAuction from "../../../assets/photo_2023-12-08_21-49-25.jpg";
import "./VideoCSS/main.css";
import "./VideoCSS/VideoConfernce.css";
    ...
    <>
      <header id="nav">
        <div className="nav--list">
          ...
          <Link to={"/"}>
            <h3 id="logo">
              <img src={logoAuction} alt="Site Logo" />
              <span>ِAuction Room</span>
            </h3>
          </Link>
        </div>
        ...
        <div id="nav__links">
          ...
          <Link className="nav__link" to="/loppy">
            Lobby
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
